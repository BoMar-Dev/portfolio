  ...
  return (
    <section className="bg-[#201E23] w-full min-h-screen p-8 flex text-[#8c8bb0]  ">
      <div className="flex flex-col items-center xl:max-w-[1200px] 2xl:max-w-[1200px] md:px-10 mx-auto bg-[#201E23] mb-10">
        ...
        <div className="flex flex-col justify-between space-y-10 xl:flex-row xl:space-x-12 xl:space-y-0 xl:mt-10 xl:text-lg ">
          <p>
            Hi! My name is Marcus, and I live in Duved, just outside Åre. I’m
            passionate about nature—I love spending my time skiing, hiking, and
            exploring new places. Wherever I go, my camera is always by my side,
            capturing the unique moments and experiences that each adventure
            brings.
          </p>
          <p>
