...
export default function Home() {
  return (
    ...
    <main className="flex flex-col bg-[#201e23]">
      <section className="bg-[#201e23] w-full min-h-screen  ">
        ...
        <div className="flex flex-col text-center  lg:hidden text-white ">
          <div>
            ...
            <h2 className="text-xl font-bold bg-gradient-to-r from-[#f0f2f1] to-[#] bg-clip-text text-transparent mt-2">
              Building Interfaces
            </h2>
        ...
        <div className="hidden lg:flex max-w-screen-xl w-full mx-auto px-12 justify-between bg-201E23 py-12 ">
          <div className="   text-[#8c8bb0] mt-10 ">
            <h1 className="text-7xl  font-black bg-gradient-to-r from-[#8c8bb0] <div className={inter.className}> to-[#f0f2f1] bg-clip-text text-transparent   ">
              Hi, It&apos;s <span className="text-white">me</span> Marcus
            </h1>
            <h2 className="flex items-center text-3xl font-bold text-[#f0f2f1] mt-5 ">
              <div className="w-11 mr-5 h-[2px] bg-white" />
              Creating Visuals
              {/* Building Interfaces */}
            </h2>
          ...
          <div className="flex items-end ">
            ...
            <Image
              ...
              width={900}
              height={500}
              className="w-70%  min-w-[300px] h-auto object-cover rounded-md  rounded-t-[90px]"
            />
          </div>
        </div>
      </section>
